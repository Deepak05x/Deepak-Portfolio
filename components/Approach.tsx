    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="Next JS, React JS, Tailwind CSS, HTML5, Framer Motion, Typescript"
        ></Card>
        <Card
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border cursor-pointer border-gray-700 hover:border-green-500 transition duration-700 group/canvas-card flex items-center justify-center
    ...
    <div>
      ...
      <button className="relative  inline-flex overflow-hidden rounded-full p-[1px] ">
        <span
         ...
         bg-[conic-gradient(from_90deg_at_50%_50%,#C3FFD9_0%,#157A6E_50%,#C3FFD9_100%)]"
        />
        <span
